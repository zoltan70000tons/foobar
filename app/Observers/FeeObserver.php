...
class FeeObserver {
    public function created(Fee $fee): void {
        ...
        GlobalLogger::log(LogActionBooking::FEE_CREATED, 'booking', $booking->id, 'Fee created', [
            'after' => [
                'fee_id' => $fee->id,
    ...
    public function deleted(Fee $fee): void {
        ...
        GlobalLogger::log(LogActionBooking::FEE_DELETED, 'booking', $booking->id, 'Fee deleted', [
            'before' => [
                'fee_id' => $fee->id,
                'passenger_id' => $fee->passenger_id,
                'amount' => $fee->amount,
