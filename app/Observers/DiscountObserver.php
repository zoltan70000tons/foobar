...
class DiscountObserver {
    public function created(PassengerDiscount $discount): void {
        ...
        GlobalLogger::log(LogActionBooking::DISCOUNT_CREATED, 'booking', $booking->id, 'Discount created', [
            'after' => [
                'fee_id' => $discount->id,
    ...
    public function deleted(PassengerDiscount $discount): void {
        ...
        GlobalLogger::log(LogActionBooking::DISCOUNT_DELETED, 'booking', $booking->id, 'Discount deleted', [
            'before' => [
