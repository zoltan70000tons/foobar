...
class EventObserver {
    public function created(Event $event): void {
        GlobalLogger::log(LogActionEvent::EVENT_CREATED, 'event', $event->id, 'Event created', [
            'after' => [
                'name' => $event->name,
    ...
    public function updated(Event $event): void {
        GlobalLogger::log(LogActionEvent::EVENT_UPDATED, 'event', $event->id, 'Event updated', [
            'before' => [
    ...
    public function deleted(Event $event): void {
        GlobalLogger::log(LogActionEvent::EVENT_DELETED, 'event', $event->id, 'Event deleted', [
            'before' => [
                'name' => $event->name,
                'description' => $event->description,
                'image' => $event->image,
