...
class CustomerBookingRepository {
    ...
    public function __construct(
        ...
        BookingActionRuleService $bookingActionRuleService,
    ...
    public function addPassengerWithToken(int $eventId, string $bookingCode, string $token, array $dataToUpdate) {
        ...
        if (
            ...
            return response()->json(
                [
                    'message' =>
                        'A passenger with this Survivor Number already exists in an active booking for this event.',
                ],
                409,
            );
        }
  ...
  */
    public function addPassengerManually(int $eventId, string $bookingCode, $passenger, $validated) {
        ...
        if ($passenger) {
            try {
                DB::transaction(function () use ($passenger, $validated, $booking, $eventId) {
                    $passenger->update([
