...
class RecoverAccountController extends Controller
{
  ...
  public function recoverAccountVerify(Request $request)
  {
    ...
    if (!$user) {
      return response()->json(
        ["message" => "There is no user with this survivor number."],
        404
      );
    }
    ...
    return response()->json(
      [
        "message" =>
          "Survivor number verified. Please proceed to update your email, username, and password.",
