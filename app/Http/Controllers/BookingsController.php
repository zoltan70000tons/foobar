    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return $this->withPermission(
                ...
                function ($event_id, $keyword, $perPage,$sortKey, $sortDirection) use ($status, $tab) {
                    // THIS IS SLOW
                    $bookings = $this->bookingRepository->getByStatus($status, $keyword,$perPage, $sortKey, $sortDirection); // Only fetch one set
