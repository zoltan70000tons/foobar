...
class AdjustmentsController extends Controller {
    ...
    public function createAdjustment(Request $request) {
        ...
        return $this->withPermission(
            ...
            function ($validated, $booking, $event_id) {
    ...
    public function deleteAdjustment(Request $request) {
        ...
        return $this->withPermission(
            ...
            function ($validated, $event_id, $booking_id) {
                DB::beginTransaction();
                ...
                try {
                    ...
                    if ($adjustment->event_id !== $event_id) {
                        return redirect()
                            ->back()
                            ->with('error', 'The adjustment does not match the specified event or booking.');
                    }
    ...
    public function updateAdjustment(Request $request) {
        ...
        try {
            ...
            $validated = $request->validate([
                'code' => ['required', Rule::unique('adjustments')->ignore($request->input('id'))],
            ...
            $this->withPermission([Permissions::EditAdjustments], function () use (
                ...
                GlobalLogger::log(LogActionBooking::ADJUSTMENT_UPDATED, 'booking', $booking->id, 'Adjustment updated', [
                    'before' => [
