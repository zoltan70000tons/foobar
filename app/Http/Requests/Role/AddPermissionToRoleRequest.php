    ...
    protected function withValidator(Validator $validator) {
        $validator->after(function ($validator) {
            ...
            if (is_null($data) && is_null($permission_id)) {
                $validator
                    ->errors()
                    ->add('permissions', 'The permissions field is required when permission_id is not present.');
                $validator
                    ->errors()
                    ->add('permission_id', 'The permission_id field is required when data is not present.');
            }
        });
    }
