...
class CustomerTagRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            'name' => ['string', 'max:64', 'min:2', 'required', 'regex:/^[A-Za-z0-9 ]+$/'],
            'description' => ['string', 'max:254', 'min:2', 'required', 'regex:/^[A-Za-z0-9 ]+$/'],
            'color' => ['string', 'max:9', 'min:4', 'required', 'regex:/^[A-Za-z0-9#]+$/'],
        ];
    }
