...
return [
  ...
  'Auth' => [
    ...
    'recover_account_instructions' =>
      '¿Has navegado anteriormente con nosotros? ¡Vincula tu correo a tu Número de Survivor!',
    'account_recovered' =>
      'Tu Número de Survivor ha sido vinculado exitosamente a tu correo electrónico. Por favor revisa tu bandeja de entrada para completar el proceso.',
    ...
    'check_email' =>
      '¡Ya casi! Antes de continuar, revisa tu correo electrónico para encontrar el enlace de verificación. Si no lo ves, por favor revisa tu carpeta de spam.',
    'link_expired' => 'El enlace de verificación ha expirado.',
    'receive_email' => 'Si no recibiste el mensaje, haz clic aquí para enviarlo nuevamente.',
    'account_terms' =>
      'Acepto los <terms>Términos y Condiciones</terms> y la <privacy>Política de Privacidad</privacy>.',
    'marketing' => 'Acepto recibir correos de promociones y/o comunicaciones',
    'dont_have_account' => '¿No tienes una cuenta aún?',
    'have_account' => '¿Ya tienes una cuenta?',
    'login_to_your' =>
      'Por favor ingresa to dirección de correo electrónico o tu Número de Survivor para ingresar a tu cuenta.',
    'phone' => 'Teléfono',
    ...
    'UpdateEmail' => [
      ...
      'disclaimer' =>
        'Por favor ten en cuenta que tu dirección de correo electrónico predeterminada es aquella que usarás para ingresar a tu cuenta. Y por defecto, será la dirección de correo electrónico que aparecerá en la Plataforma de Reservas.',
    ],
    ...
    'Error' => [
      ...
      'invalid_session_request' =>
        'Solicitud inválida o el tiempo ha expirado. Por favor, actualiza la página e intenta nuevamente',
      'identifier' => [
