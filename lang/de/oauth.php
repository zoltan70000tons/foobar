...
return [
    ...
    */
    ...
    'Auth' => [
        ...
        'check_email' => "Fast fertig! Bevor es weitergeht, gucke bitte in Deinem eMailpostfach nach dem Verifizierungslink. Solltest Du ihn nicht finden, gucke bitte in Deinem Spamordner nach.",
        'receive_email' => "Wenn Du die Nachricht nicht erhalten hast, klicke bitte hier, um eine neue anzufordern.",
        'account_terms' => "Ich stimme den <terms>Vertragsbedingungen und Konditionen</terms>  und <privacy>Datenschutzrichtlinien</privacy> zu.",
        ...
        'login_to_your' => "Bitte verwende Deine eMailadresse oder Deine Survivornummer, um Dich bei Deinem Account anzumelden.",
        'phone' => "Telefon",
        ...
        'UpdateEmail' => [
            ...
            'disclaimer' => "Bitte bedenke, dass Deine übliche eMailadresse die ist, mit der Du Dich bei Deinem Account anmeldest. Sie wird auch die eMailadresse für die Buchungsplattform sein.",
        ],
        ...
        'Error' => [
            ...
            'invalid_session_request' => "Ungültige Anfrage oder Zeit abgelaufen. Bitte aktualisiere die Seite und versuche es erneut.",
            'identifier' => [
