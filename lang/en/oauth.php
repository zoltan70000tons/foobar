...
return [
    ...
    */
    ...
    'Auth' => [
        ...
        'check_email' => "Almost there! Before proceeding, please check your eMail for a verification link. If you did not see the email, please check your spam folder.",
        ...
        'UpdateEmail' => [
            ...
            'disclaimer' => "Please note that your default eMail address is the one you use to log in to your account. It will also be the default eMail address on the booking platform.",
        ],
