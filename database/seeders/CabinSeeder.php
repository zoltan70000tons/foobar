...
class CabinSeeder extends Seeder {
    ...
    public function run() {
        ...
        if ($this->command) {
            ...
            $this->command->warn(
                "⚠️  Reseeding cabins will reset inventory. You should cancel these bookings before proceeding.\n",
            );
        ...
        foreach ($csv as $record) {
            ...
            $cabinSpec = CabinSpec::updateOrCreate(
                ...
                [
                    ...
                    'connects_with' => $record['Connects with']
                        ? CabinSpec::where('cabin_number', $record['Connects with'])->first()?->id
                        : null,
