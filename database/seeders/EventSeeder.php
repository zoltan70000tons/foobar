  ...
  public function run(): void
  {
    ...
    if (!$exists) {
      DB::table('events')->insert([
        ...
        'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2026.jpg',
        'address' => 'Miami, Florida - Labadee, Haiti',
    ...
    DB::table('events')->insert([
      ...
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2025.jpg',
    ...
    DB::table('events')->insert([
      ...
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2024.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2023.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '62 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2020.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2019.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2018.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2017.jpg',
      'address' => 'Ft. Lauderdale, FL – Labadee, Haiti – Ft. Lauderdale, FL',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2016.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2015.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2014.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2013.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2012.jpg',
    ...
    DB::table('events')->insert([
      ...
      'description' =>
        '60 Bands, 4 Days, 1 Cruise Ship, and only 3000 Tickets. This is 70000TONS OF METAL®, The Original, The World’s Biggest Heavy Metal Cruise!',
      'image' => env('AWS_URL') . '/events/70000TONS_OF_METAL_2011.jpg',
    ...
    DB::table('events')->insert([
      ...
      'image' => env('AWS_URL') . '/events/BARGE_TO_HELL_2012.jpg',
