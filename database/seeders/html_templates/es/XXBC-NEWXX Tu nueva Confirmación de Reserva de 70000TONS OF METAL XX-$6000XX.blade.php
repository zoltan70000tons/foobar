...
<html>
  <head>
    ...
    <title>XXBC-NEWXX Tu nueva Confirmación de Reserva de 70000TONS OF
      METAL XX-$6000XX</title>
  </head>
  <body>
    <table
...
style="display:
                                            ...
                                            es de: USD {INDIVIDUAL_PAYMENT}<br>
...
style="padding: 0px
                                            ...
                                            para que realizes tu
                                            check-in en línea por correo
                                            electrónico alrededor de
                                            tres (3) semanas antes del
                                            crucero. Este correo
                                            electrónico incluirá
                                            credenciales de login con
                                            las cuales puedes completar
                                            el Check-in online e
                                            imprimir tu(s) Pase(s) de
                                            Abordaje de manera similar
                                            al Check-in Online para un
                                            vuelo. También puedes hacer
                                            el Check-in en el muelle el
                                            día de la salida, pero te
                                            aconsejamos que lo hagas en
                                            línea para ahorrarte tiempo
                                            y evitar filas cuando
