              ...
              30px;" align="center">
                ...
                <tr>
                  <td class="text-footer1 pb10"
                    style="color: rgb(119, 119,
              119); font-family: Arial,
              sans-serif; font-size: 14px;
              line-height: 20px;
              text-align: left;
              padding-bottom: 10px;">70000TONS

                    OF METAL Hotline:<br>
                    Aus den USA und Kanada
                    gebührenfrei: 1 888 70K TONS
                    (1 888 705 8667)<br>
                    Aus allen anderen Regionen:
                    +1 305 777 4878<br>
                    <br>
                    Unsere Hotline ist montags
                    bis freitags von 15:00 bis
                    03:00 MESZ erreichbar.<br>
                    <br>
                    <a
                      href="https://www.70000tons.com" target="_blank"
                      style="color: rgb(0, 0,
                238); text-decoration:
                underline;">www.70000tons.com</a><br>
                    <br>
                    Diese eMail enthält
                    vertrauliche und/oder
                    rechtlich geschützte
                    Informationen und ist
                    ausschließlich an den oben
                    genannten Empfänger
                    gerichtet. Das unerlaubte
                    Kopieren sowie die unbefugte
                    Weitergabe dieser eMail sind
                    nicht gestattet. Wenn Sie
                    nicht der richtige Empfänger
                    sind oder diese eMail
