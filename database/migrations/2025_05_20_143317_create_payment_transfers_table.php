...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('payment_transfers', function (Blueprint $table) {
            ...
            $table
                ->foreignId('payment_id_from') // ID of the payer (negative amount)
            ...
            $table
                ->foreignId('payment_id_to') // ID of the receiver (positive amount)
                ->constrained('payments') // Foreign key reference to the payments table
                ->onDelete('cascade'); // Delete the transfer if the payment is deleted
            $table->foreignId('passenger_id_from')->constrained('passengers')->onDelete('cascade');
            $table->foreignId('passenger_id_to')->constrained('passengers')->onDelete('cascade');
