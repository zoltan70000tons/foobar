...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement("CREATE INDEX IF NOT EXISTS taggings_booking_idx ON taggings ((entity_id::bigint)) WHERE entity_type = 'booking'");
        DB::statement("CREATE INDEX IF NOT EXISTS taggings_cabin_idx   ON taggings ((entity_id::bigint)) WHERE entity_type = 'cabin'");
        DB::statement("CREATE INDEX IF NOT EXISTS taggings_customer_idx ON taggings ((entity_id::uuid)) WHERE entity_type = 'customer'");
        DB::statement("CREATE INDEX IF NOT EXISTS taggings_user_idx     ON taggings ((entity_id::uuid)) WHERE entity_type = 'user'");
