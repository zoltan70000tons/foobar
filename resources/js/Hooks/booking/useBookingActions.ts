...
export function useBookingActions() {
  ...
  return {
    ...
    setSelectedLocation: (location: string) => dispatch(actions.setSelectedLocation(location)),
    setSelectedDeck: (deck: number) => dispatch(actions.setSelectedDeck(deck)),
    ...
    setCreatedCustomer: (payload: Customer) => dispatch(actions.setCreatedCustomer(payload)),
