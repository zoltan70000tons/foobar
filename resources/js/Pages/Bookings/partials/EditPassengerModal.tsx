...
const EditPassengerModal = ({
  ...
  return (
    <>
      <Dialog open={open} onClose={handleOnClose} fullScreen fullWidth maxWidth="lg" disableEscapeKeyDown={false}>
        <Box
          sx={{
            position: "sticky",
            top: 0,
        ...
        >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
              ...
              <Chip label={`BC: ${booking.booking_code}`} color="info" variant="outlined" sx={{ fontWeight: 500 }} />
            </Box>
            ...
            <Box mt={2} display="flex" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap={1}>
              <Stack direction="row" spacing={1} justifyContent="flex-end">
                <Tooltip
                  title={
                    passenger?.empty_seat
                      ? "Remove the empty seat marker to allow a new passenger assignment"
                      : "Mark this spot as empty - no passenger will occupy this bed"
                  }
                  arrow
                >
                  <span>
                    ...
                    >
                      {passenger?.empty_seat ? "Unset Empty Bed" : "Set Empty Bed"}
                    </LoadingButton>
                  </span>
                </Tooltip>
                {canReset && (
                  <Tooltip title="Clear this passenger and reset the spot for a new assignment" arrow>
                    <span>
                      <LoadingButton
                ...
                <Tooltip title="Save all changes made to this passenger's information" arrow>
                  <span>
                    <LoadingButton
                ...
                {passenger?.survivor_number && !disabledByDesign && (
                  <Tooltip title="Open the Customer Portal profile to update their permanent account information" arrow>
                    <a
                ...
                <Tooltip title={disabledByDesign ? "Close this modal" : "Discard changes and close this modal"} arrow>
        ...
        <Paper sx={{ p: 4, width: "100%" }}>
          {passenger?.empty_seat && (
            <Typography variant="body2" color="error" gutterBottom marginBottom={1}>
              This passenger is marked as an Empty Bed. Please RELEASE the empty bed option to edit the passenger
              details.
            </Typography>
          )}
          ...
          <Grid>
            ...
            <Grid container spacing={2} alignItems="center" sx={{ mb: "1rem" }}>
              <Grid item xs={12} md={3}>
                <FormControl fullWidth error={!!validation?.payment_method}>
                  ...
                  {validation?.payment_method?.[0] && <FormHelperText>{validation.payment_method[0]}</FormHelperText>}
                </FormControl>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2} alignItems="center" sx={{ mb: "1rem" }}>
              ...
              <Grid item xs={12}>
                <SpecialRequest disabledByDesign={disabledByDesign} onChange={onChange} passenger={passenger} />
              </Grid>
              <Grid item xs={12} md={2}>
                <FormControlLabel
                  control={
