...
import { CheckCircle, Block, HourglassEmpty, Close, ArrowBack, Rule, Cabin } from "@mui/icons-material";
...
const Create = ({ auth, event, categories }: Props) => {
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  <Autocomplete
                    ...
                    onChange={(event, newValue) => setData("cabin_category_id", newValue ? newValue.id : "")}
                    renderInput={(params) => (
                      <TextField
                        {...params}
