...
const Edit = ({ auth, cabin, event, categories, shared, errors }: Props) => {
  ...
  const [selectedCategoryForSharedCabin, setSelectedCategoryForSharedCabin] = useState(null);
...

      {
        ...
        draw: (row) => (
          ...
          >
            ...
            {CabinStatus[row.status as keyof typeof CabinStatus]}
          </Box>
        ),
      },
      {
  ...
  const handleSaveCategoryToSharedCabin = () => {
    if (!selectedCategoryForSharedCabin) {
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={openCategoryDialog} onClose={handleCloseCategoryDialog}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleSaveCategoryToSharedCabin} variant="contained" color="primary">
            Save Category
          </Button>
        </DialogActions>
      </Dialog>
