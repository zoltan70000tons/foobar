    ...
    return [
      {
        ...
        getApplyFilterFn: (filterItem) => {
          ...
          return (value) =>
            Array.isArray(value) && value.some((v) => v.toLowerCase().includes(filterItem.value.toLowerCase()));
        },
      ...
      },
      {
        ...
        getApplyFilterFn: (filterItem) => {
          if (!filterItem.value) return null;
          return (value) => Array.isArray(value) && value.includes(filterItem.value);
        },
        InputComponent: GridFilterInputValue,
      },
      {
        ...
        getApplyFilterFn: (filterItem) => {
          if (!filterItem.value) return null;
          return (value) =>
            Array.isArray(value) && value.some((v) => v.toLowerCase().startsWith(filterItem.value.toLowerCase()));
        },
        InputComponent: GridFilterInputValue,
      },
      {
        ...
        getApplyFilterFn: (filterItem) => {
          if (!filterItem.value) return null;
          return (value) =>
            Array.isArray(value) && value.some((v) => v.toLowerCase().endsWith(filterItem.value.toLowerCase()));
        },
        InputComponent: GridFilterInputValue,
      },
      {
      ...
      },
      {
        ...
        getApplyFilterFn: (filterItem) => {
          ...
          return (value) => Array.isArray(value) && value.some((v) => filterItem.value.includes(v));
        },
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box display="flex" justifyContent="flex-end" width="100%">
          <ActionMenu params={params} onUpdate={fetchData} />
        </Box>
      ),
    },
  ];
