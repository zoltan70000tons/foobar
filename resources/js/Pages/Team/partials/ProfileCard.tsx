    ...
    <Card variant="outlined" sx={{ borderRadius: 0, background: "#383838" }}>
      ...
      >
        <Grid item sx={{ p: "1.5rem 0rem", textAlign: "center" }}>
          ...
          >
            <Avatar sx={{ width: 100, height: 100, mb: 1.5 }}>L</Avatar>
          </Badge>
        ...
        <Grid container>
          ...
          <Grid item xs={6} sx={{ textAlign: "end" }}>
            ...
            <Typography style={styles.value}>
              <Chip size="small" label={user?.roles[0] ? user?.roles[0] : "Pending"} color="default" />
            </Typography>
          </Grid>
        </Grid>
        <Grid item style={styles.details} sx={{ width: "100%", height: "100px" }}></Grid>
      </Grid>
    </Card>
  );
}
