...
export default function SurvivorLogin() {
  ...
  const { tAuth, tGeneral, language, flash } = usePage<SurvivorLoginProps>().props;
  ...
  return (
    ...
    >
      <AnimatedBorder xmlns="http://www.w3.org/2000/svg">
        ...
        <rect rx="18" ry="18" className="line" height="100%" width="100%" strokeLinejoin="round" />
      </AnimatedBorder>
      <Info sx={{ color: "text.primary" }} />

      <Typography variant="body1">
        {tAuth?.recover_account_instructions ??
