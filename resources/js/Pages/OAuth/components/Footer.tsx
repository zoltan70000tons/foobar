...
import { ExpandMore, Facebook, Instagram, Twitter, YouTube, Telegram } from "@mui/icons-material";
  ...
  const sections = [
    {
      ...
      links: [
        { href: `https://70000tons.com/artists/?lang=${locale}`, text: tFooter?.Event?.artists || "Artists" },
        {
    ...
    },
    {
      ...
      links: [
        ...
        { href: `https://70000tons.com/faq/?lang=${locale}`, text: tFooter?.Support?.faq || "FAQ" },
        {
    ...
    >
      <Container>
        <Grid container spacing={2} rowSpacing={2}>
          <Grid xs={12} md={6} display="flex" justifyContent={{ xs: "center", md: "flex-start" }} alignItems="center">
            <img src="/70k_logo.png" alt="70000TONS OF METAL" width={275} height={53} />
          </Grid>

          <Grid xs={12} md={6} display="flex" justifyContent="flex-end" alignItems="center">
            <Stack
              direction="row"
              spacing={1}
              sx={{
            ...
            >
              <CustomLink href="https://web.facebook.com/70000tons?_rdc=1&_rdr" color="inherit" type="iconButton">
                <Facebook />
              </CustomLink>
              <CustomLink href="https://www.instagram.com/70000tons/" color="inherit" type="iconButton">
                <Instagram />
              </CustomLink>
              <CustomLink href="https://x.com/70000tons" color="inherit" type="iconButton">
                <Twitter />
              </CustomLink>
              <CustomLink href="http://www.youtube.com/70000tons" color="inherit" type="iconButton">
                <YouTube />
              </CustomLink>
              <CustomLink href="https://www.tiktok.com/@70000tons?lang=en" color="inherit" type="iconButton">
                <svg
              ...
              <CustomLink href="https://bsky.app/profile/70000tons.bsky.social" color="inherit" type="iconButton">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <CustomLink href="https://www.threads.net/@70000tons" color="inherit" type="iconButton">
                <svg
                  width={22}
                  height={22}
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <CustomLink href="https://t.me/original70000tons" color="inherit" type="iconButton">
                <Telegram />
              </CustomLink>
              <CustomLink
                    ...
                    <Stack spacing={1.5}>
                      {section.links
                        ...
                        : section.content.map((item, contentIndex) => (
                            <Typography key={contentIndex} sx={{ fontSize: "0.875rem" }}>
                              {item.text}
                            </Typography>
                          ))}
                    </Stack>
