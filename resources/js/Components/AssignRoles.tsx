...
function getStyles(name: string, permissionName: readonly string[], theme: Theme) {
  return {
    fontWeight:
      permissionName.indexOf(name) === -1 ? theme.typography.fontWeightRegular : theme.typography.fontWeightMedium,
  };
}
  ...
  useEffect(() => {
    const fetchPermissions = async () => {
      try {
        ...
        const grantedPermissions = permissionsData
    ...
    <Grid container xs={12} sm={12} md={12} lg={12}>
      ...
      >
        ...
        <p style={{ visibility: "hidden" }}>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam dicta fugit adipisci quisquam sed soluta quo,
          dolor dolores quasi eveniet animi beatae ducimus, itaque est doloribus pariatur cupiditate atque? Sit?
        </p>
      </Box>
    </Grid>
  );
